...
Ok, finally, let's see what this data looks like. First a chart to show averages and quartile ranges for the gaps by stage type. First we create a data object, then the plots. Faceting by stage type didn't work because the y axis ranges were very different. So we'll use patchwork to stitch them together in one plot.
```{r tt_letour2, fig.width=7.5, fig.height=4.0, dpi = 300,  echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
gapranges <- stage_gap %>%
