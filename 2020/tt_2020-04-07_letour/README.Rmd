...
Ok, now let's look at the changes in the mountaints from the winners to the time for the last rider(s).
```{r tt_letour2c, fig.width=7.5, fig.height=4.0, dpi = 300,  echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
