---
title: "Tidy Tuesday Baltimore Bridges"
author: "greg dubrow"
date: "3/21/2020"
output: md_document
---
...
```{r tt_baltbrdf, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr01, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
tt_baltdf %>% 
  mutate(county = str_replace(county, " County", "")) %>%
  count(decade_built) %>%
...
```{r tt_baltbr02, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr03, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr04, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr05, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr06, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr07, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr08, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr09, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr10, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr11, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
