...
```{r tt_baltbr01, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
tt_baltdf %>% 
  mutate(county = str_replace(county, " County", "")) %>%
  count(decade_built) %>%
...
```{r tt_baltbr02, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr03, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr04, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr05, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr06, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr07, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr08, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr09, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr10, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_baltbr11, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
